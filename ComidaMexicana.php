...
<style>
	body {
		background-image: url('img/ComidaMexicana/CoMexFond.png');
...
<div class='container'>
	...
	$query = "select*from comidamexicana";
			...
			<section class='p-4 mt-3 p-md-5 text-white rounded site-tr-gray'>
				<div class='row justify-content-center align-items-center g-2'>
					...
					<div class='col-sm-12 col-xl-6 text-center'>
						<img src='img/ComidaMexicana/" . $reg[4] . "' class='mg-fluid w-50 rounded-circle'>
					</div>
					<div class='col-sm-12 col-xl-6 text-center'>
