...
<style>
	body {
		background-image: linear-gradient(to bottom,#13718f,#34b2c0,#fff);
	}
</style>
...
<div class='container'>
	...
	$query = "select*from comidavegana";
			...
			<section class='p-4 mt-3 p-md-5 text-white rounded site-tr-gray'>
				<div class='row justify-content-center align-items-center g-2'>
					...
					<div class='col-sm-12 col-xl-6 text-center'>
						<img src='img/ComidaVegana/" . $reg[4] . "' class='mg-fluid w-50 rounded-circle'>
					</div>
					<div class='col-sm-12 col-xl-6 text-center'>
